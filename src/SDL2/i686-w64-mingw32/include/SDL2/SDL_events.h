...
typedef struct SDL_MouseWheelEvent {
  ...
  double preciseX;  /**< The amount scrolled horizontally, positive to the right
                       and negative to the left, with double precision (added
                       in 2.0.18) */
  double preciseY;  /**< The amount scrolled vertically, positive away from the
                       user and negative toward the user, with double precision
                       (added in 2.0.18) */
} SDL_MouseWheelEvent;
...
typedef struct SDL_ControllerSensorEvent {
  ...
  Sint32 sensor;        /**< The type of the sensor, one of the values of
                           ::SDL_SensorType */
  double data[3];       /**< Up to 3 values from the sensor, as defined in
                           SDL_sensor.h */
...
typedef struct SDL_SensorEvent {
  ...
  double data[6]; /**< Up to 6 values from the sensor - additional values can be
