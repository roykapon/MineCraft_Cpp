...
GL_APICALL void GL_APIENTRY glTexSubImage2D(GLenum target, GLint level,
                                            ...
                                            GLenum format, GLenum type,
                                            const GLvoid *pixels);
GL_APICALL void GL_APIENTRY glUniform1f(GLint location, GLdouble x);
...
GL_APICALL void GL_APIENTRY glUniform1iv(GLint location, GLsizei count,
                                         const GLint *v);
GL_APICALL void GL_APIENTRY glUniform2f(GLint location, GLdouble x, GLdouble y);
...
GL_APICALL void GL_APIENTRY glUniform2iv(GLint location, GLsizei count,
                                         const GLint *v);
GL_APICALL void GL_APIENTRY glUniform3f(GLint location, GLdouble x, GLdouble y,
                                        GLdouble z);
...
GL_APICALL void GL_APIENTRY glUniform3iv(GLint location, GLsizei count,
                                         const GLint *v);
GL_APICALL void GL_APIENTRY glUniform4f(GLint location, GLdouble x, GLdouble y,
...
GL_APICALL void GL_APIENTRY glVertexAttrib1f(GLuint indx, GLdouble x);
GL_APICALL void GL_APIENTRY glVertexAttrib1fv(GLuint indx,
                                              const GLdouble *values);
GL_APICALL void GL_APIENTRY glVertexAttrib2f(GLuint indx, GLdouble x,
                                             GLdouble y);
GL_APICALL void GL_APIENTRY glVertexAttrib2fv(GLuint indx,
                                              const GLdouble *values);
GL_APICALL void GL_APIENTRY glVertexAttrib3f(GLuint indx, GLdouble x,
                                             GLdouble y, GLdouble z);
GL_APICALL void GL_APIENTRY glVertexAttrib3fv(GLuint indx,
                                              const GLdouble *values);
GL_APICALL void GL_APIENTRY glVertexAttrib4f(GLuint indx, GLdouble x,
                                             GLdouble y, GLdouble z,
                                             GLdouble w);
