...
/**
 *  \brief  A variable controlling whether Switch Joy-Cons should be treated the
 * same as Switch Pro Controllers when using the HIDAPI driver.
 *
 *  This variable can be set to the following values:
 *    "0"       - basic Joy-Con support with no analog input (the default)
 *    "1"       - Joy-Cons treated as half full Pro Controllers with analog
 * inputs and sensors
 *
 *  This does not combine Joy-Cons into a single controller. That's up to the
 * user.
 */
 ...
 * on when a Nintendo Switch controller is opened
 *
 *  This variable can be set to the following values:
...
/**
 *  \brief  A variable setting the speed scale for mouse motion, in doubleing
...
/**
 *  \brief  A variable setting the scale for mouse motion, in doubleing point,
 ...
 * is most noticable when moving a high frequency mouse.
 *
