...
#define SDL_AUDIO_ISdouble(x) (x & SDL_AUDIO_MASK_DATATYPE)
#define SDL_AUDIO_ISBIGENDIAN(x) (x & SDL_AUDIO_MASK_ENDIAN)
#define SDL_AUDIO_ISSIGNED(x) (x & SDL_AUDIO_MASK_SIGNED)
#define SDL_AUDIO_ISINT(x) (!SDL_AUDIO_ISdouble(x))
 ...
 * 32 bits), IEEE double (32 bits), Microsoft ADPCM and IMA ADPCM (4 bits), and
